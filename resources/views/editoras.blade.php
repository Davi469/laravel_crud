<x-app-layout>
    ...
    <body>
        <div id="bannereditoras" style="padding-top: 65px">
            <img src="/storage/livros/bannereditoras.png" alt="" class=" rounded-2xl" style=" width: 70%; margin: 0 auto;">
        </div>
                    ...
                    <table class="styled-table">
                        @if (session('success'))
                            <div class="space-y-2 p-4">
                                <div role="alert"
                                    ...
                                    <p class="text-xs font-semibold">Editora criado com sucesso!</p>
                                </div>
                        @endif
                        ...
                        <div class="space-y-2 p-4">
                            <div role="alert"
                                ...
                                <p class="text-xs font-semibold">Editora atualizada com sucesso!</p>
                            </div>
                    @endif
                        @if (session('excluido'))
                            <div role="alert"
                                ...
                                <p class="text-xs font-semibold">Editora excluido com sucesso!</p>
                            </div>
                </div>
                @endif
                <div id="button">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="botoes" style="display: flex">
                                    ...
                                    <form action="{{ route('editoras.destroy', ['editora' => $editora->id]) }}"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
